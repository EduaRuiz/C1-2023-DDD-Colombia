import { UnsubscribedGroupEventPublisher } from '.';
import { GroupDomainEntity } from '../../../entities';
import { Topic } from '../enums/topic.enum';

describe('UnsubscribedGroupEventPublisher', () => {
  class MockEventPublisher extends UnsubscribedGroupEventPublisher {}
  ...
  describe('publish', () => {
    ...
    it('should emit an event with the response', async () => {
      // Arrange
      const expectedChannel = Topic.UnsubscribedGroup;
