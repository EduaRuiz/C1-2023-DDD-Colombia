import { GotInscriptionsEventPublisher } from '.';
import { InscriptionDomainEntity } from '../../../entities';
import { Topic } from '../enums/topic.enum';

describe('GotInscriptionsEventPublisher', () => {
  class MockEventPublisher extends GotInscriptionsEventPublisher {}
  ...
  describe('publish', () => {
    ...
    it('should emit an event with the response', async () => {
      // Arrange
      const expectedChannel = Topic.GotInscriptions;
