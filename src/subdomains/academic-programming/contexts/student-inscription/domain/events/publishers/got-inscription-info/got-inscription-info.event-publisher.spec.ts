import { GotInscriptionInfoEventPublisher } from '..';
import { InscriptionDomainEntity } from '../../../entities';
import { Topic } from '../enums/topic.enum';

describe('GotInscriptionInfoEventPublisher', () => {
  class MockEventPublisher extends GotInscriptionInfoEventPublisher {}
  ...
  describe('publish', () => {
    ...
    it('should emit an event with the response', async () => {
      // Arrange
      const expectedChannel = Topic.GotInscriptionInfo;
